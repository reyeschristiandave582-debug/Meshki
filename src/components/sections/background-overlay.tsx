  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden opacity-15">
          <Image
            src="https://i.imgur.com/0DsEyil.png"
            alt=""
            width={100}
            height={100}
          ...
          />
          <Image
            src="https://i.imgur.com/T8st9Rn.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/4cKhhrF.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/RxL8Re0.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/jCgyejq.png"
            alt=""
            width={80}
            height={80}
